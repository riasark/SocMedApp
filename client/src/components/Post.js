        ...
        <div class="p-4 md:p-5 flex flex-wrap">
          ...
          <div>
            <div class="relative inline-flex">
                    <button type="button" onClick={openModal} class={`${isCurrentUser ? "" : "disabled opacity-0 display-none"} hs-dropdown-toggle flex justify-center items-center size-9 text-sm font-semibold rounded-lg border border-gray-200 bg-red-600 hover:bg-red-700 text-gray-800 shadow-sm disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-white dark:hover:bg-neutral-800`} >
              ...
              <div class="relative inline-flex">
                    <p className={`${!isCurrentUser ? "" : "disabled opacity-0 display-none"} mr-2 mt-1.5`}>{props.likes}</p>
                    <button type="button" onClick={toggleLike} class={`${!isCurrentUser ? "" : "disabled opacity-0 display-none"} rounded-full hs-dropdown-toggle flex justify-center items-center size-9 text-sm font-semibold border border-gray-200 ${liked ? "bg-pink-400 hover:bg-pink-500" : "bg-blue-600 hover:bg-blue-700"} text-gray-800 shadow-sm disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-white dark:hover:bg-neutral-800`} >
        ...
        <div class={`hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 ${isModalOpen ? "" : "opacity-0"} ease-out transition-all sm:max-w-lg sm:w-full m-3 sm:mx-auto`}>
          <div class="flex flex-col bg-white border shadow-sm rounded-xl pointer-events-auto dark:bg-neutral-800 dark:border-neutral-700 dark:shadow-neutral-700/70">
            ...
            <div class="flex justify-end items-center gap-x-2 py-3 px-4 border-t dark:border-neutral-700">
              ...
              <button type="button" onClick={deletePost} class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-red-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">
                Delete Post
              </button>
            </div>
          </div>
