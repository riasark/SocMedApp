...
function LoginPage() {
    return (
        <div className="mt-7 w=1/2 bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-neutral-900 dark:border-neutral-700">
            <div className="p-4 sm:p-7">
                ...
                <form>
                    ...
                    <div className="flex items-center">
                        ...
                        <div className="ms-3">
                        <label for="remember-me" className="text-sm dark:text-white">I accept the <a className="text-blue-600 decoration-2 hover:underline font-medium dark:text-blue-500" href="/">Terms and Conditions</a></label>
                        </div>
                    </div>
