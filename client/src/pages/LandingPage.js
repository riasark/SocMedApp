            ...
            <div class="relative z-10">
                <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-16">
                    <div class="max-w-2xl text-center mx-auto my-20">
                        <p class="inline-block text-sm font-medium bg-clip-text bg-gradient-to-l from-pink-300 to-pink-600 text-transparent dark:from-pink-100 dark:to-pink-200">
                            A New Way to Connect With People
                        </p>

                        {/* <!-- Title --> */}
                        <div class="mt-6 max-w-4xl">
                            <h1 class="block font-serif text-white text-8xl md:text-8xl lg:text-9xl">
                                Hobbify
                            </h1>
                        </div>
                        {/* <!-- End Title --> */}
